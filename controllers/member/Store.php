...
class Store extends CI_Controller
{
  ...
  function cart_show()
  {
    ...
    $output .= '<tr>
                    <th colspan="2" style="text-align:right;"><p style="color:orange;">Subtotal :</p></th>
                    <th colspan="2" style="text-align:right;"><p style="color:orange;">' . 'Rp ' . number_format($this->cart->total(), 0, ',', ',') . '</p></th>
                </tr>
                <tr>
                  <th colspan="2" style="text-align:right;"><p style="color:orange;">Biaya Pengiriman :</p></th>
                  <th colspan="2" style="text-align:right;">
                    <p id="shipping_costs_text" style="color:orange;">0</p>
                  </th>
                </tr>
                <tr>
                  <th colspan="2" style="text-align:right;"><p style="color:green;">Discount Level (' . $discount . '%) :</p></th>
                  <th colspan="2" style="text-align:right;">
                ...
                <tr>
                  <th colspan="2" style="text-align:right;"><h4 style="color:red;">Total Tagihan :</h4></th>
                  <th colspan="2" style="text-align:right;">
                    <h4 style="color:red;" id="total_tagihan">' . 'Rp ' . number_format($total, 0, ',', ',') . '</h4>
  ...
  function act_add_transaction()
  {
    ...
    $courier_name = $this->input->post('shipingdesc'); //nama kurir
